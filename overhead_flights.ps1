function timestamp { Process{"$(Get-Date -Format G): $_"} }
...
Write-host "Starting flight monitor >>>" -ForegroundColor Green
Write-host "Home Lat: $homeLat" -ForegroundColor DarkGray
Write-host "Home Lon: $homeLon" -ForegroundColor DarkGray
